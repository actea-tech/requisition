...
const styles = StyleSheet.create({
  ...
  accentBar: { flexDirection: "row", height: 2.5, marginTop: 16, marginBottom: 4 },
  accentThird: { flex: 1 },
  subheading: { fontSize: 8.5, color: BRAND.muted, marginTop: 10, marginBottom: 22 },
  ...
  historyHeaderRow: { flexDirection: "row", paddingBottom: 6, borderBottom: `1 solid ${BRAND.text}` },
